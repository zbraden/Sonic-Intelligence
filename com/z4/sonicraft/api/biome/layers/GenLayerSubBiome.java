...
import com.z4.sonicraft.api.biome.SoundSubBiome;
import com.z4.sonicraft.common.utils.SimplexNoise;
	...
	public int[] getInts(int x, int z, int width, int length)
    {
        ...
        for (int xi = 0; xi < width; ++xi) 
        {
        	for (int zi = 0; zi < length; ++zi) 
        	{
        		...
        		List<BiomeEntry> currentSubBiomes = SonicraftBiomeManager.overworldSubBiomes[currentBiomeId];
        		SoundSubBiome selectedSubBiome = currentSubBiomes != null ? (SoundSubBiome)currentSubBiomes.get(this.nextInt(currentSubBiomes.size())).biome : null;
