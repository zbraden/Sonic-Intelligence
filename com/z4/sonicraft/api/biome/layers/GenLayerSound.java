...
public abstract class GenLayerSound extends GenLayer{
	public GenLayerSound(long par1) 
	{
		super(par1);
	}
    ...
    {
        boolean flag = false;
        GenLayer genLayerCreateLand = new GenLayerIsland(1L);
        ...
        for (int j = 0; j < b0; ++j)
        {
            ...
            if (j == 1)
            {
                object = new GenLayerShoreSound(1000L, (GenLayer)object);
            }
        }
