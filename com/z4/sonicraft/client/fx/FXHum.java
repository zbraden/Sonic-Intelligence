package com.z4.sonicraft.client.fx;
...
public class FXHum extends EntityFX
{
    ...
    private static final ResourceLocation tex = new ResourceLocation(Reference.MODID, "textures/particles/humFX.png");

    public FXHum(World world, double x, double y, double z, float var8, float red, float green, float blue, int mult)
    {
    ...
    public FXHum(World world, double x, double y, double z, float var8, int color, int var10)
    {
    ...
    public FXHum(World var1, double var2, double var4, double var6, double var8, double var10, double var12, float var14, int var15, int var16)
    {
    ...
    public void onUpdate()
    {
        ...
        {
            FXHum name = new FXHum(this.worldObj, this.prevPosX + (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.1F), this.prevPosY + (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.1F), this.prevPosZ + (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.1F), 1.0F, this.currentColor, 3 + this.worldObj.rand.nextInt(3));
            name.noClip = true;
